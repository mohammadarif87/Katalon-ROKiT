...
<WebElementEntity>
   ...
   <name>android.view.View0 - The IKEA website uses cookies which make the site simpler to use.</name>
   <tag></tag>
   ...
   <webElementProperties>
      ...
      <name>text</name>
      <type>Main</type>
      <value>The IKEA website uses cookies, which make the site simpler to use. </value>
   </webElementProperties>
   <webElementProperties>
