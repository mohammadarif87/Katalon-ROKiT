...
public class TestlinkKeywords {
	...
	static {
		try {
			...
			//}
			TESTLINK_URI = 'http://52.16.182.4/lib/api/xmlrpc/v1/xmlrpc.php'
			...
			//}
			if (userName == 'Aiden') {
				TEST_PLAN_NAME = 'Io Pro (US)'
			} else {
				TEST_PLAN_NAME = 'Io Pro (EU)'
			}
			...
			//}
			BUILD_NAME = 'SW81-rok-emu-9.0-IAS649D'
