...
if (Mobile.verifyElementNotVisible(findTestObject('Apps/Music FX/android.widget.TextView10 - MusicFX'), 0, FailureHandling.OPTIONAL)) {
    Mobile.swipe(startX, startY, endX, endY)
}
...
if (Mobile.verifyElementVisible(findTestObject('Apps/Music FX/android.widget.TextView10 - MusicFX'), 0, FailureHandling.OPTIONAL)) {
    Mobile.tap(findTestObject('Apps/Music FX/android.widget.TextView10 - MusicFX'), 0)
}

Mobile.verifyElementVisible(findTestObject('Apps/Music FX/android.widget.TextView2 - MusicFX'), 0)

Mobile.verifyElementVisible(findTestObject('Apps/Music FX/android.widget.TextView3 - Installed'), 0)

Mobile.verifyElementVisible(findTestObject('Apps/Music FX/android.widget.Button0 - DISABLE'), 0)

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'("Music FX App Pre-Installed", "", TestLinkAPIResults.TEST_PASSED)