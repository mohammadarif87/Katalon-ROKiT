...
Mobile.verifyElementVisible(findTestObject('Apps/Carrier Services/android.widget.TextView8 - Carrier Services'), 5)

Mobile.tap(findTestObject('Apps/Carrier Services/android.widget.TextView8 - Carrier Services'), 0)

Mobile.verifyElementVisible(findTestObject('Apps/Carrier Services/android.widget.TextView2 - Carrier Services'), 0)

Mobile.verifyElementVisible(findTestObject('Apps/Carrier Services/android.widget.TextView3 - Installed'), 0)

Mobile.verifyElementVisible(findTestObject('Apps/Carrier Services/android.widget.Button0 - DISABLE'), 0)

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Carrier Services App Pre-Installed', '', 
