...
Mobile.verifyElementVisible(findTestObject('Apps/Clock/Snooze the alarm/android.widget.Switch1 - OFF'), 0)

Mobile.tap(findTestObject('Apps/Clock/Snooze the alarm/android.widget.Switch1 - OFF'), 0)

Mobile.verifyElementVisible(findTestObject('Apps/Clock/Snooze the alarm/android.widget.Switch1 - ON'), 0)

Mobile.tap(findTestObject('Apps/Clock/Snooze the alarm/android.widget.Switch1 - ON'), 0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Toggle On/Off', '', TestLinkAPIResults.TEST_PASSED)
