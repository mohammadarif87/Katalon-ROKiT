...
if (Mobile.verifyElementNotVisible(findTestObject('Apps/Google Services Framework/android.widget.TextView8 - Google Services Framework'), 
...
Mobile.verifyElementVisible(findTestObject('Apps/Google Services Framework/android.widget.TextView8 - Google Services Framework'), 
    0)

Mobile.tap(findTestObject('Apps/Google Services Framework/android.widget.TextView8 - Google Services Framework'), 0)

Mobile.verifyElementVisible(findTestObject('Apps/Google Services Framework/android.widget.TextView2 - Google Services Framework'), 
    0)

Mobile.verifyElementVisible(findTestObject('Apps/Google Services Framework/android.widget.TextView3 - Installed'), 0)

Mobile.verifyElementVisible(findTestObject('Apps/Google Services Framework/android.widget.Button0 - DISABLE'), 0)

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'("Google Services Framework App Pre-Installed", "", TestLinkAPIResults.TEST_PASSED)