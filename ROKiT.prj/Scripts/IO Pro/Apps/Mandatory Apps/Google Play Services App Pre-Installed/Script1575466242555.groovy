...
if (Mobile.verifyElementNotVisible(findTestObject('Apps/Google Play Services/android.widget.TextView5 - Google Play services'), 
...
Mobile.verifyElementVisible(findTestObject('Apps/Google Play Services/android.widget.TextView5 - Google Play services'), 
    0)

Mobile.tap(findTestObject('Apps/Google Play Services/android.widget.TextView5 - Google Play services'), 0)

Mobile.verifyElementVisible(findTestObject('Apps/Google Play Services/android.widget.TextView0 - App info'), 0)

Mobile.verifyElementVisible(findTestObject('Apps/Google Play Services/android.widget.TextView2 - Google Play services'), 
    0)

Mobile.verifyElementVisible(findTestObject('Apps/Google Play Services/android.widget.TextView3 - Installed'), 0)

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'("Google Play Services App Pre-Installed", "", TestLinkAPIResults.TEST_PASSED)