...
Mobile.verifyElementVisible(findTestObject('Apps/Google Drive/android.view.View1 - Sign in'), 8)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Play Movies & TV App Pre-Installed', '', 
