...
Mobile.verifyElementVisible(findTestObject('Apps/Photos/android.widget.Button0 - Sign in to back up'), 3)

Mobile.pressBack()

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Photos App Pre-Installed', '', TestLinkAPIResults.TEST_PASSED)
