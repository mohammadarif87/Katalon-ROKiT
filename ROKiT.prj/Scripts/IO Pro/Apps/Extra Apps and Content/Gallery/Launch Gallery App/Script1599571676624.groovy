...
Mobile.verifyElementVisible(findTestObject('Apps/Gallery/android.widget.TextView16 - Gallery'), 0)

Mobile.tap(findTestObject('Apps/Gallery/android.widget.TextView16 - Gallery'), 0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Launch Gallery App', '', TestLinkAPIResults.TEST_PASSED)
