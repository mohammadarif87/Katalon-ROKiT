...
if (userName == 'Aiden') {
    ...
    'Google Logo'
    Mobile.verifyElementVisible(findTestObject('Apps/Extra Apps and Content/Internet App/Accept Terms And Privacy/android.widget.ImageView0'), 
        0)
    ...
    Mobile.setText(findTestObject('Apps/Extra Apps and Content/Internet App/Search/android.widget.EditText0 - Search or type web address'), 
        'Duba', 0)

    'This is a suggestion after typing the word "Duba"'
    Mobile.verifyElementVisible(findTestObject('Apps/Extra Apps and Content/Internet App/Search/android.widget.TextView0 - dubai'), 
        0)

    'This is a suggestion after typing the word "Duba"'
    Mobile.tap(findTestObject('Apps/Extra Apps and Content/Internet App/Search/android.widget.TextView0 - dubai'), 0)

    Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

    Mobile.verifyElementVisible(findTestObject('Apps/Extra Apps and Content/Internet App/Search/android.view.View0 - Dubai'), 
        0)

    Mobile.verifyElementVisible(findTestObject('Apps/Extra Apps and Content/Internet App/Search/android.view.View0 - City in the United Arab Emirates'), 
        0)
    ...
    Mobile.setText(findTestObject('Apps/Internet/android.widget.EditText0 - Search or type web address (1)'), 'Duba', 0)
    ...
    Mobile.tapAtPosition(777, 820)

    Mobile.verifyElementVisible(findTestObject('Apps/Extra Apps and Content/Internet App/Accept Terms And Privacy/android.widget.TextView0 - Internet (2)'), 
        0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Internet App Search', '', TestLinkAPIResults.TEST_PASSED)
