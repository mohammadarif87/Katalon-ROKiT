...
if (userName == 'Aiden') {
    ...
    Mobile.tap(findTestObject('Apps/Internet/android.widget.Button1 - Reject'), 0)

    Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

    Mobile.verifyElementNotVisible(findTestObject('Apps/Internet/android.widget.TextView0 - Search or type web address (1)'), 
        3)

    'Google Logo'
    Mobile.verifyElementNotVisible(findTestObject('Apps/Extra Apps and Content/Internet App/Accept Terms And Privacy/android.widget.ImageView0'), 
        0)
} else {
    ...
    Mobile.verifyElementVisible(findTestObject('Apps/Internet/android.widget.TextView1 - Welcome to Karma'), 0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Reject Terms & Privacy', '', TestLinkAPIResults.TEST_PASSED)
