...
if (userName == 'Aiden') {
    ...
    Mobile.verifyElementVisible(findTestObject('Apps/Extra Apps and Content/Internet App/Accept Terms And Privacy/android.widget.TextView0 - Internet'), 
        0)

    Mobile.tap(findTestObject('Apps/Extra Apps and Content/Internet App/Accept Terms And Privacy/android.widget.TextView0 - Internet'), 
        0)

    Mobile.verifyElementNotVisible(findTestObject('Apps/Internet/android.widget.TextView2 - By using this application you agree to Libertys Terms of Service and Privacy Notice.'), 
        0)
    ...
    not_run: Mobile.verifyElementVisible(findTestObject('Apps/Extra Apps and Content/Internet App/Accept Terms And Privacy/android.widget.TextView0 - Search or type web address'), 
        0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Accept Terms & Privacy', '', TestLinkAPIResults.TEST_PASSED)
