...
not_run: if (Mobile.verifyElementVisible(findTestObject('Preconditions/IO 3D Mobile Data Disable from Quick Settings/android.widget.TextView5 - Mobile data'), 
