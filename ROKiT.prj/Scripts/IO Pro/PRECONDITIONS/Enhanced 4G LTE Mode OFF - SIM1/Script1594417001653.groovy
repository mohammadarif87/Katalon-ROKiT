...
if (Mobile.verifyElementVisible(findTestObject('Preconditions/Enhanced 4G LTE Mode OFF/android.widget.Switch0 - OFF'), 0, 
    FailureHandling.OPTIONAL)) {
    Mobile.comment('If VoLTE is OFF, then check it is OFF')

    Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

    Mobile.verifyElementVisible(findTestObject('Preconditions/Enhanced 4G LTE Mode OFF/android.widget.Switch0 - OFF'), 0)
} else {
    Mobile.comment('Else if VoLTE is ON then turn it OFF')
    ...
    Mobile.verifyElementVisible(findTestObject('Preconditions/Enhanced 4G LTE Mode OFF/android.widget.Switch0 - ON'), 0)
}
