...
Mobile.verifyElementVisible(findTestObject('Preconditions/Reset options/Reset app preferences/android.widget.TextView0 - Advanced'), 
    0)

Mobile.tap(findTestObject('Preconditions/Reset options/Reset app preferences/android.widget.TextView0 - Advanced'), 0)
