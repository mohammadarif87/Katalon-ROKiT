...
Mobile.tap(findTestObject('Preconditions/Sleep Time/android.widget.CheckedTextView0 - 10 minutes'), 0)

Mobile.verifyElementVisible(findTestObject('Preconditions/Sleep Time/android.widget.TextView0 - After 10 minutes of inactivity'), 
    3)
