...
Mobile.tap(findTestObject('Preconditions/Sleep Time/Set sleep to 30 seconds/android.widget.CheckedTextView0 - 30 seconds'), 
    0)

Mobile.getText(findTestObject('Preconditions/Sleep Time/Set sleep to 30 seconds/android.widget.TextView0 - After 30 seconds of inactivity (1)'), 
    0)
