...
Mobile.tap(findTestObject('Preconditions/Sleep Time/android.widget.CheckedTextView0 - 1 minute'), 0)

Mobile.verifyElementVisible(findTestObject('Preconditions/Sleep Time/android.widget.TextView0 - After 1 minute of inactivity'), 
    3)
