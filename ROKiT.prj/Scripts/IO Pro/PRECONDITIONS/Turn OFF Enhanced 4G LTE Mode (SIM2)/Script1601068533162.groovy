...
Mobile.tap(findTestObject('Preconditions/Turn OFF Enhanced 4G LTE Mode/android.widget.TextView0 - Advanced'), 3)
...
not_run: Mobile.getText(findTestObject('Preconditions/Turn OFF Enhanced 4G LTE Mode/android.widget.Switch0 - ON'), 3)
