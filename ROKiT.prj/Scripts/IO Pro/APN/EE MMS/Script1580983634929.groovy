...
Mobile.verifyElementVisible(findTestObject(('APN/IO Pro/EE UK APN/android.widget.TextView3 - ' + carrier_EEMMS)), 
    0)
...
Mobile.verifyElementVisible(findTestObject('APN/IO Pro/EE UK APN/android.widget.TextView3 - ' + mmsproxy_149254201135), 0)
