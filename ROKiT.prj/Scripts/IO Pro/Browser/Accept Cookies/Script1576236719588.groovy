...
if (userName == 'Aiden') {
    ...
    if (Mobile.verifyElementVisible(findTestObject('Browser/Open Web Page/android.widget.EditText0 - bbc.co.uk'), 0, FailureHandling.OPTIONAL)) {
        not_run: Mobile.waitForElementPresent(findTestObject('Browser/Accept Cookies/android.view.View5 - Weve updated our Privacy and Cookies Policy'), 
            0)

        not_run: Mobile.verifyElementVisible(findTestObject('Browser/Accept Cookies/android.widget.Button0 - OK (1)'), 0)

        not_run: Mobile.tap(findTestObject('Browser/Accept Cookies/android.widget.Button0 - OK (1)'), 0)

        Mobile.verifyElementVisible(findTestObject('Browser/Accept Cookies/android.view.View0 - Let us know you agree to cookies'), 
            0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Accept Cookies', '', TestLinkAPIResults.TEST_PASSED)
