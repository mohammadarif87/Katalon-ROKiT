...
if (userName == 'Aiden') {
    ...
    not_run: Mobile.verifyElementVisible(findTestObject('Apps/Chrome/android.widget.Button0 - No thanks'), 0)

    not_run: Mobile.tap(findTestObject('Apps/Chrome/android.widget.Button0 - No thanks'), 0)
...
not_run: Mobile.tap(findTestObject('Apps/Chrome/android.widget.TextView0 - Facebook'), 0)

not_run: Mobile.verifyElementVisible(findTestObject('Apps/Chrome/android.widget.EditText2 - httpsm.facebook.com'), 0)

not_run: Mobile.pressBack()

Mobile.verifyElementVisible(findTestObject('Apps/Chrome/android.widget.TextView1 - YouTube'), 0)

not_run: Mobile.tap(findTestObject('Apps/Chrome/android.widget.TextView1 - YouTube'), 0)

not_run: Mobile.verifyElementVisible(findTestObject('Apps/Chrome/android.widget.EditText0 - httpsm.youtube.com'), 0)

not_run: Mobile.pressBack()

not_run: Mobile.verifyElementVisible(findTestObject('Apps/Chrome/android.widget.TextView2 - Amazon UK'), 0)

not_run: Mobile.tap(findTestObject('Apps/Chrome/android.widget.TextView2 - Amazon UK'), 0)

not_run: Mobile.verifyElementVisible(findTestObject('Apps/Chrome/android.widget.EditText1 - httpswww.amazon.co.uk'), 0)

not_run: Mobile.pressBack()

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Launch Browser', '', TestLinkAPIResults.TEST_PASSED)
