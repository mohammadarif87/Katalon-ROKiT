...
'Enter on Keyboard'
Mobile.tapAtPosition(2000, 1020)
...
if (Mobile.verifyElementNotVisible(findTestObject('Browser/Search/android.widget.EditText0 - red hippopotamus'), 3, FailureHandling.OPTIONAL)) {
    'Refresh icon'
    Mobile.tapAtPosition(150, 150)

    if (Mobile.verifyElementNotVisible(findTestObject('Browser/Chrome/Search Landscape Mode/android.widget.ImageButton3'), 
        ...
        '3 dots in top right'
        Mobile.tap(findTestObject('Browser/Chrome/Search Landscape Mode/android.widget.ImageButton3'), 3)
    }
    
    Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

    'Refresh icon'
    Mobile.tap(findTestObject('Browser/Chrome/Search Landscape Mode/android.widget.ImageButton4'), 3)
}
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Search Landscape Mode', '', TestLinkAPIResults.TEST_PASSED)
