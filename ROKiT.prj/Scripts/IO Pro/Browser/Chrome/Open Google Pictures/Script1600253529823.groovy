...
Mobile.verifyElementVisible(findTestObject('Browser/Search/android.widget.EditText0 - red hippopotamus'), 3)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

AndroidDriver<MobileElement> driver = MobileDriverFactory.getDriver()

driver.findElementByXPath('//android.view.View[@content-desc = \'IMAGES\']').isDisplayed()

driver.findElementByXPath('//android.view.View[@content-desc = \'IMAGES\']').click()

not_run: Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open Google Pictures/android.widget.TextView0 - IMAGES'), 
    3)

not_run: Mobile.tap(findTestObject('Browser/Chrome/Open Google Pictures/android.widget.TextView0 - IMAGES'), 0)

Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open Google Pictures/android.view.View0 - Latest'), 3)

Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open Google Pictures/android.widget.Image0'), 0)

Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open Google Pictures/android.view.View0 - HD'), 3)

'1st picture '
not_run: Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open Google Pictures/android.view.View0'), 3)

'2nd picture'
not_run: Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open Google Pictures/android.view.View0 (1)'), 0)

AndroidDriver<MobileElement> driverImage = MobileDriverFactory.getDriver()

'Look for 1st and 2nd picture'
driverImage.findElementByXPath('//android.widget.Image[contains(@text, \'Do Hippos Sweat Blood? Learn About Hippo Perspiration\')]').isDisplayed()

driverImage.findElementByXPath('//android.widget.Image[contains(@text, \'Hippopotamus » Talk — Zooniverse\')]').isDisplayed()

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Open Google Pictures', '', TestLinkAPIResults.TEST_PASSED)
