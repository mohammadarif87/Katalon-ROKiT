...
Mobile.swipe(530, 1650, 530, 650)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.swipe(530, 650, 530, 1650)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Search Portrait Mode', '', TestLinkAPIResults.TEST_PASSED)
