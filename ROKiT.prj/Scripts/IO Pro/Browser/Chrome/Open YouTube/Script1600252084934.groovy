...
Mobile.setText(findTestObject('Browser/Chrome/Open YouTube/android.widget.EditText0 - Search or type web address'), 'Youtube.com', 
    0)
...
if (userName == 'Aiden') {
    ...
    'Youtube text in Agreement Popup'
    Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open YouTube/android.widget.Image0'), 0)

    not_run: Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open YouTube/android.view.View0 - a Google company'), 
        0)

    Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open YouTube/android.widget.Button0 - See more about your choices for cookies and other data'), 
        0)

    Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open YouTube/android.widget.Button0 - Agree to the use of cookies and other data for the purposes described'), 
        0)

    Mobile.tap(findTestObject('Browser/Chrome/Open YouTube/android.widget.Button0 - Agree to the use of cookies and other data for the purposes described'), 
        0)
...
if (Mobile.verifyElementNotVisible(findTestObject('Browser/Chrome/Open YouTube/android.view.View0 - Home'), 0, FailureHandling.OPTIONAL)) {
    '3 dots in top right'
...
Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open YouTube/android.view.View0 - Home'), 0)

Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open YouTube/android.view.View0 - Trending'), 0)

Mobile.verifyElementVisible(findTestObject('Browser/Chrome/Open YouTube/android.view.View0 - Library'), 0)

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Open YouTube', '', TestLinkAPIResults.TEST_PASSED)
