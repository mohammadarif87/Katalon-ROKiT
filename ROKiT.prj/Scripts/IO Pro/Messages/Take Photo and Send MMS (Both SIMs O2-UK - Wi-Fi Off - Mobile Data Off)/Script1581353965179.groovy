...
'Capture picture button'
Mobile.tap(findTestObject('Messages/Send MMS (SIM 1 - O2-UK)/android.widget.ImageView8'), 0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Take Photo and Send MMS (Both SIMs, Wi-Fi Off, Mobile Data Off)', 
    'SIM 1 = O2-UK', TestLinkAPIResults.TEST_PASSED)
