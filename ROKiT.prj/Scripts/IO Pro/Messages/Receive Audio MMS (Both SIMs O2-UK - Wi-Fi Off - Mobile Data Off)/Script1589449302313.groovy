...
WebUI.callTestCase(findTestCase('IO 3D/Messages/Send MMS Audio to IO Pro'), [('appPackage') : 'com.google.android.apps.messaging'
...
if (Mobile.verifyElementVisible(findTestObject('Messages/Send Audio MMS to IO Pro/android.widget.TextView1 - Audio clip'), 
    ...
    'Audio in message'
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Audio MMS from IO Pro/android.widget.ImageView1 (1)'), 
        10)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Receive Audio MMS (Both SIMs, Wi-Fi Off, Mobile Data Off)', 
