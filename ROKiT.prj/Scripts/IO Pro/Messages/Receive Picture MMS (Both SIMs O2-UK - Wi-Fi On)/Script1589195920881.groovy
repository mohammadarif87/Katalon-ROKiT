...
WebUI.callTestCase(findTestCase('IO 3D/Messages/Send MMS Picture to IO Pro'), [('appPackage') : 'com.google.android.apps.messaging'
...
not_run: if (Mobile.verifyElementVisible(findTestObject('Messages/Send SMS to Contact (SIM 1 - O2-UK)/android.widget.TextView0 - Messages just got better'), 
...
not_run: if (Mobile.verifyElementVisible(findTestObject('Preconditions/Delete Messages/android.widget.TextView - Next'), 
    0, FailureHandling.OPTIONAL)) {
...
not_run: if (Mobile.verifyElementVisible(findTestObject('Messages/Send SMS to Contact (SIM 1 - O2-UK)/android.widget.TextView0 - Enter your phone number for the following SIM to finish setting up chat features'), 
    0, FailureHandling.OPTIONAL)) {
...
if (Mobile.verifyElementVisible(findTestObject('Messages/Receive Picture MMS (Both SIMs - Wi-Fi On)/android.widget.TextView1 - Picture'), 
    0, FailureHandling.OPTIONAL)) {
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Picture MMS (Both SIMs - Wi-Fi On)/android.widget.TextView1 - Picture'), 
        0)
    ...
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Picture MMS(Both SIMs O2-UK - Wi-Fi On)/android.widget.TextView0 - Unsupported file'), 
        0)
    ...
    Mobile.tap(findTestObject('Messages/Receive Picture MMS(Both SIMs O2-UK - Wi-Fi On)/android.widget.FrameLayout0'), 0)

    Mobile.delay(30, FailureHandling.STOP_ON_FAILURE)
}

not_run: Mobile.tap(findTestObject('Messages/Receive Picture MMS (Both SIMs - Wi-Fi On)/android.widget.TextView0 - Auto O2 Fav'), 
    0)

not_run: Mobile.verifyElementVisible(findTestObject('Messages/Receive Picture MMS (Both SIMs - Wi-Fi On)/android.widget.TextView3 - Auto O2 Fav'), 
    0)

'Picture in the message'
Mobile.verifyElementVisible(findTestObject('Messages/Receive Picture MMS (Both SIMs - Wi-Fi On)/android.widget.ImageView1'), 
    0)

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Receive Picture MMS (Both SIMs, Wi-Fi On)', 
