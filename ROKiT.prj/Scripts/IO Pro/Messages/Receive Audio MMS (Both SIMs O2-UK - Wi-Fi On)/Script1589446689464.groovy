...
if (userName == 'Aiden') {
    ...
    if (Mobile.verifyElementVisible(findTestObject('Messages/Send Audio MMS to IO Pro/android.widget.TextView1 - Audio clip'), 
        ...
        'Download icon for audio'
        Mobile.tap(findTestObject('Messages/Receive Picture MMS (Both SIMs - Wi-Fi On)/android.widget.FrameLayout6'), 3)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Receive Audio MMS (Both SIMs, Wi-Fi On)', 
