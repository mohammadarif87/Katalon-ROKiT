...
if (userName == 'Aiden') {
    if (Mobile.verifyElementVisible(findTestObject('Languages and Translations/Keypad Characters/android.widget.TextView0 - English (US) (QWERTY) Bulgarian (Bulgarian)'), 
        0, FailureHandling.OPTIONAL)) {
        Mobile.verifyElementVisible(findTestObject('Languages and Translations/Keypad Characters/android.widget.TextView0 - English (US) (QWERTY) Bulgarian (Bulgarian)'), 
            0)
    } else {
...
if (userName == 'Aiden') {
    Mobile.tapAtPosition(180, 850)

    if (Mobile.verifyElementVisible(findTestObject('Languages and Translations/Keypad Characters/android.widget.EditText0 - Chat (T-Mobile)'), 
        0, FailureHandling.OPTIONAL)) {
        Mobile.verifyElementVisible(findTestObject('Languages and Translations/Keypad Characters/android.widget.EditText0 - Chat (T-Mobile)'), 
            3)

        Mobile.tap(findTestObject('Languages and Translations/Keypad Characters/android.widget.EditText0 - Chat (T-Mobile)'), 
            0)
    }
    
    if (Mobile.verifyElementVisible(findTestObject('Languages and Translations/Keypad Characters/android.widget.EditText0 - Text (T-Mobile)'), 
        0, FailureHandling.OPTIONAL)) {
        Mobile.verifyElementVisible(findTestObject('Languages and Translations/Keypad Characters/android.widget.EditText0 - Text (T-Mobile)'), 
            0)

        Mobile.tap(findTestObject('Languages and Translations/Keypad Characters/android.widget.EditText0 - Text (T-Mobile)'), 
            0)
    }
} else {
    Mobile.verifyElementVisible(findTestObject('Languages and Translations/Keypad Characters/android.widget.TextView5 - Auto O2 Fav'), 
        0)

    Mobile.tap(findTestObject('Languages and Translations/Keypad Characters/android.widget.TextView5 - Auto O2 Fav'), 0)

    Mobile.verifyElementVisible(findTestObject('Languages and Translations/Keypad Characters/android.widget.EditText0 - Text (O2 - UK)'), 
        0)

    Mobile.tap(findTestObject('Languages and Translations/Keypad Characters/android.widget.EditText0 - Text (O2 - UK)'), 
        0)
}
...
Mobile.tap(findTestObject('System Settings/System/Languages and input/Gboard/Gboard Add keyboard/android.widget.TextView0 - Bulgarian (5)'), 
    0)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

'q'
Mobile.tapAtPosition(50, 1470)

'w'
Mobile.tapAtPosition(170, 1470)

'e'
Mobile.tapAtPosition(280, 1470)

'r'
Mobile.tapAtPosition(370, 1470)

't'
Mobile.tapAtPosition(480, 1470)

'y'
Mobile.tapAtPosition(540, 1470)
...
'Явертъ'
Mobile.verifyElementVisible(findTestObject('Languages and Translations/Keypad Characters/android.widget.EditText0 - '), 
    0)

Mobile.comment('Delete Bulgarian')
...
if (Mobile.verifyElementNotVisible(findTestObject('3D/Apps/3D Gallery/View Photo Video in MMS on 3D Gallery/android.widget.TextView0 - Watch the 3D effect by turning the phone in landscape mode'), 
    0, FailureHandling.OPTIONAL)) {
    Mobile.swipe(512, 500, 512, 1400)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Keypad Characters', '', TestLinkAPIResults.TEST_PASSED)
