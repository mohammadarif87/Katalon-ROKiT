...
Mobile.verifyElementVisible(findTestObject('3D/Apps/3D Gallery/Manage Phone Call Permission/android.widget.TextView0 - 3D Gallery'), 
    0)

Mobile.tap(findTestObject('3D/Apps/3D Gallery/Manage Phone Call Permission/android.widget.TextView0 - 3D Gallery'), 0)

Mobile.verifyElementVisible(findTestObject('3D/Apps/3D Gallery/Manage Phone Call Permission/android.widget.TextView0 - Permissions'), 
    0)

Mobile.tap(findTestObject('3D/Apps/3D Gallery/Manage Phone Call Permission/android.widget.TextView0 - Permissions'), 0)

Mobile.verifyElementVisible(findTestObject('3D/Apps/3D Gallery/Manage Phone Call Permission/android.widget.TextView0 - Camera'), 
    0)

Mobile.verifyElementVisible(findTestObject('3D/Apps/3D Gallery/Manage Phone Call Permission/android.widget.TextView0 - Location'), 
    0)

Mobile.verifyElementVisible(findTestObject('3D/Apps/3D Gallery/Manage Phone Call Permission/android.widget.TextView0 - Storage'), 
    0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Manage 3D Gallery Phone Call Permission', 
