...
'Info button'
Mobile.tap(findTestObject('Gallery/View Images/android.widget.ImageView1'), 0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('View Details', '', TestLinkAPIResults.TEST_PASSED)
