...
'Green tick battery'
Mobile.verifyElementVisible(findTestObject('Settings/Battery/View Battery Info/android.widget.ImageView1'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Settings/Battery/View Battery Info/android.widget.TextView5 - Apps are running normally'), 
    0, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Settings/Battery/View Battery Info/android.widget.TextView6 - Phone has typical background battery usage'), 
    0, FailureHandling.STOP_ON_FAILURE)

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('View Battery Info', '', TestLinkAPIResults.TEST_PASSED)
