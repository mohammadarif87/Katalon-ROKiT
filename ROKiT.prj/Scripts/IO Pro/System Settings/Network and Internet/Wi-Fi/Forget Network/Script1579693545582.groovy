...
Mobile.tap(findTestObject('Preconditions/Turn on Wi-Fi/android.widget.TextView4 - Connected'), 0)

not_run: Mobile.tap(findTestObject('Preconditions/Turn on Wi-Fi/android.widget.TextView3 - ROKiT Test 5G'), 0)
...
not_run: Mobile.verifyElementVisible(findTestObject('Settings/Network and Internet/View Network Details/android.widget.TextView3 - ROKiT Test 5G'), 
    0)
...
Mobile.tap(findTestObject('Settings/Network and Internet/View Network Details/android.widget.Button0 - FORGET'), 0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Forget Network', '', TestLinkAPIResults.TEST_PASSED)
