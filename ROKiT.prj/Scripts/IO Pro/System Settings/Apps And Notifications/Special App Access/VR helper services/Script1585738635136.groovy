...
Mobile.verifyElementVisible(findTestObject('System Settings/Apps And Notifications/Special App Access/VR helper services/android.widget.TextView0 - VR helper services'), 
    0)

Mobile.tap(findTestObject('System Settings/Apps And Notifications/Special App Access/VR helper services/android.widget.TextView0 - VR helper services'), 
    0)

Mobile.verifyElementVisible(findTestObject('System Settings/Apps And Notifications/Special App Access/VR helper services/android.widget.TextView0 - No installed apps have requested to be run as VR helper services.'), 
    0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('VR helper services', '', TestLinkAPIResults.TEST_PASSED)
