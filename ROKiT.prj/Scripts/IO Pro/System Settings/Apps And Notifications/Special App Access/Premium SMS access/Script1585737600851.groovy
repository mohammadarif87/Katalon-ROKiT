...
Mobile.verifyElementVisible(findTestObject('System Settings/Apps And Notifications/Special App Access/Premium SMS access/android.widget.TextView0 - Premium SMS access'), 
    0)

Mobile.tap(findTestObject('System Settings/Apps And Notifications/Special App Access/Premium SMS access/android.widget.TextView0 - Premium SMS access'), 
    0)

Mobile.verifyElementVisible(findTestObject('System Settings/Apps And Notifications/Special App Access/Premium SMS access/android.widget.TextView0 - No installed apps have requested Premium SMS access'), 
    0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Premium SMS access', '', TestLinkAPIResults.TEST_PASSED)
