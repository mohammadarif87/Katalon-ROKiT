...
Mobile.tap(findTestObject('System Settings/System/Multiple Users/Add User/android.widget.Button0 - KEEP USER'), 0)
...
Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.TextView4 - New user'), 
    0)

'Settings icon next to New User'
Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.ImageView2'), 
    0)

'Settings icon next to New User'
Mobile.tap(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.ImageView2'), 0)

Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.TextView0 - New user'), 
    0)

Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.TextView2 - Turn on phone calls  SMS'), 
    0)

Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.Switch0 - OFF'), 
    0)

Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.TextView3 - Remove user'), 
    0)

Mobile.tap(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.TextView3 - Remove user'), 0)

Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.TextView0 - Remove this user'), 
    0)

Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.TextView1 - All apps and data will be deleted.'), 
    0)

Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.Button0 - CANCEL'), 
    0)

Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.Button1 - DELETE'), 
    0)

Mobile.tap(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.Button1 - DELETE'), 0)

Mobile.delay(30, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementNotVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.TextView4 - New user'), 
    30)

if (userName == 'Aiden') {
    Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Remove User/android.widget.TextView0 - You (Rokit)'), 
        3)
} else {
    Mobile.verifyElementVisible(findTestObject('System Settings/System/Multiple Users/Guest User/android.widget.TextView2 - You (Owner)'), 
        0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Remove User', '', TestLinkAPIResults.TEST_PASSED)
