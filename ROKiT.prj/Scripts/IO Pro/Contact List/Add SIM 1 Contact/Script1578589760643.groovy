...
if (userName == 'Aiden') {
    ...
    Mobile.tap(findTestObject('Contact List/Add SIM 1 Contact/android.widget.TextView0 - T-Mobile'), 0)

    Mobile.verifyElementVisible(findTestObject('Contact List/Add SIM 1 Contact/android.widget.TextView0 - T-Mobile (1)'), 
        0)

    Mobile.setText(findTestObject('Contact List/Add SIM 1 Contact/android.widget.EditText0 - Name'), 'Automation SIM 1', 
        0)
    ...
    Mobile.verifyElementVisible(findTestObject('Contact List/Add SIM 1 Contact/android.widget.TextView9 - Automation SIM 1'), 
        0)
    ...
    Mobile.tap(findTestObject('Contact List/Add SIM 1 Contact/android.widget.TextView4 - O2 - UK'), 0)

    Mobile.verifyElementVisible(findTestObject('Contact List/Add SIM 1 Contact/android.widget.TextView2 - O2 - UK'), 0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('SIM 1 Contact', '', TestLinkAPIResults.TEST_PASSED)
