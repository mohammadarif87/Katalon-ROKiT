...
WebUI.callTestCase(findTestCase('IO Pro/PRECONDITIONS/Sleep Time/Set sleep to 1 minute'), [('appPackage') : 'com.android.settings'
        , ('appActivity') : '.Settings', ('deviceInformation') : [('platformVersion') : '9', ('deviceName') : 'ROKiT IO Pro (Android 9)'
            , ('deviceId') : 'IOPRO0123456789A', ('platformName') : 'Android']], FailureHandling.STOP_ON_FAILURE)

Mobile.delay(62, FailureHandling.STOP_ON_FAILURE)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Automatic Lock - 1 minute', '', TestLinkAPIResults.TEST_PASSED)
