...
Mobile.verifyElementVisible(findTestObject('Security/Lock screen/Verify PIN screen lock from Settings/android.widget.Button0 - YES'), 
    3)

Mobile.tap(findTestObject('Security/Lock screen/Verify PIN screen lock from Settings/android.widget.Button0 - YES'), 3)

Mobile.verifyElementVisible(findTestObject('Security/Lock screen/Verify PIN screen lock from Settings/android.widget.TextView0 - Require PIN (1)'), 
    3)

userName = System.getProperty('user.name')

if (userName == 'Aiden') {
    Mobile.verifyElementVisible(findTestObject('Security/Lock screen/Verify PIN screen lock from Settings/android.widget.TextView0 - When you enter your PIN to start this device accessibility services like  wont yet be available. (2)'), 
        3)
} else {
    Mobile.verifyElementVisible(findTestObject('Security/Lock screen/Verify PIN screen lock from Settings/android.widget.TextView0 - When you enter your PIN to start this device accessibility services like  wont yet be available. (1)'), 
        3)
}

Mobile.verifyElementVisible(findTestObject('Security/Lock screen/Verify PIN screen lock from Settings/android.widget.Button0 - CANCEL (1)'), 
    3)

Mobile.verifyElementVisible(findTestObject('Security/Lock screen/Verify PIN screen lock from Settings/android.widget.Button0 - OK (1)'), 
    3)

Mobile.tap(findTestObject('Security/Lock screen/Verify PIN screen lock from Settings/android.widget.Button0 - OK (1)'), 
    3)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Verify PIN screen lock from Settings', 
