...
while (Mobile.verifyElementVisible(findTestObject('Camera/Rear Camera Resolution/android.widget.TextView1'), 0, FailureHandling.OPTIONAL)) {
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'("Delete a photo and video", "", TestLinkAPIResults.TEST_PASSED)