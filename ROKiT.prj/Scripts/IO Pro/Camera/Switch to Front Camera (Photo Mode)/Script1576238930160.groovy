...
Mobile.verifyElementVisible(findTestObject('Camera/android.widget.TextView0 - Capture Mode'), 0)
...
Mobile.verifyElementNotVisible(findTestObject('Camera/android.widget.TextView3 - HDR'), 0)
...
Mobile.verifyElementNotVisible(findTestObject('Camera/android.widget.TextView8 - Pose'), 0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'("Switch to Front Camera (Photo Mode)", "", TestLinkAPIResults.TEST_PASSED)