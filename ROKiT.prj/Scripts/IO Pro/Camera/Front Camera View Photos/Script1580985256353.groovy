...
'Beauty Mode'
Mobile.verifyElementVisible(findTestObject('Camera/Front Camera View Photos/android.widget.ImageView0'), 0)

'Beauty Mode'
Mobile.tap(findTestObject('Camera/Front Camera View Photos/android.widget.ImageView0'), 0)
...
'Gallery button'
Mobile.verifyElementVisible(findTestObject('Camera/Front Camera View Photos/android.widget.ImageView2'), 0)

'Gallery button'
Mobile.tap(findTestObject('Camera/Front Camera View Photos/android.widget.ImageView2'), 0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Front Camera View Photos', '', TestLinkAPIResults.TEST_PASSED)
