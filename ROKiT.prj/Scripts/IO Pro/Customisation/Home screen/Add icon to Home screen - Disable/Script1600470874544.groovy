...
Mobile.tap(findTestObject('Customisation/Home screen/Add icon to Home screen/android.widget.TextView0 - Add icon to Home screen'), 
    3)
...
WebUI.callTestCase(findTestCase('IO Pro/PRECONDITIONS/Download Network Cell Info App ONLY'), [('appPackage') : 'com.android.vending'
        , ('appActivity') : '.AssetBrowserActivity', ('deviceInformation') : [('platformVersion') : '9', ('deviceName') : 'ROKiT IO Pro (Android 9)', ('deviceId') : 'IOPRO0123456789A', ('platformName') : 'Android']], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementNotVisible(findTestObject('Customisation/Home screen/Add icon to Home screen/android.widget.TextView0 - Network Cell Info Lite'), 
    3)
...
Mobile.comment('Enable Add icon to Home screen')
...
'Add icon to Home screen ON'
not_run: driver.findElementByXPath('//android.widget.Switch[@instance = \'2\'][contains(@text, \'ON\')]').isDisplayed()

Mobile.closeApplication()

not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Add icon to Home screen - Disable', '', 
