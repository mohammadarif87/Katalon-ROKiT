...
Mobile.swipe(70, 1900, 70, 800)

'Google Assistant Lock Screen displayed'
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Shortcut in the lockscreen', '', TestLinkAPIResults.TEST_PASSED)
