...
if (userName == 'Aiden') {
    Mobile.verifyElementVisible(findTestObject('Customisation/SIM SPN instead of CARD1-CARD2/android.widget.TextView0 - T-Mobile - 14787777307'), 
        3)
    ...
    Mobile.verifyElementVisible(findTestObject('Customisation/SIM SPN instead of CARD1-CARD2/android.widget.TextView0 - ATT - 14244169828'), 
        3)
} else {
...
Mobile.verifyElementVisible(findTestObject('Settings/Network and Internet/SIM Cards/android.widget.Switch0 - OFF'), 3)
...
if (userName == 'Aiden') {
    Mobile.verifyElementVisible(findTestObject('Customisation/SIM SPN instead of CARD1-CARD2/android.widget.TextView0 - NO SERVICE  ATT'), 
        3)
} else {
...
Mobile.verifyElementVisible(findTestObject('Settings/Network and Internet/SIM Cards/android.widget.Switch1 - OFF'), 3)
...
if (userName == 'Aiden') {
    Mobile.getText(findTestObject('Customisation/SIM SPN instead of CARD1-CARD2/android.widget.TextView0 - T-MOBILE  NO SERVICE'), 
        0)
} else {
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('SIM SPN instead of CARD1-CARD2', 'SIM 1 = O2-UK\nSIM2 = EE', 
