...
if (userName == 'Aiden') {
    ...
    Mobile.tap(findTestObject('Phone App/Place Call to Favourite (SIM 1 O2-UK)/android.widget.TextView0 - Calling via EE'), 
        0)
}
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Place Call to Favourite (SIM 2)', 'SIM 1 = O2-UK\nSIM 2 = EE', 
