...
Mobile.comment('Run in parallel execution with Place Call CS Fallback (SIM 2 EE) using IO 3D')
...
'4G Icon Not Visible'
if (Mobile.verifyElementNotVisible(findTestObject('Network/Preferred Network Type (SIM 1 - O2-UK)/android.widget.TextView10 - 4G'), 
    10, FailureHandling.OPTIONAL)) {
    Mobile.closeNotifications()
}
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('CS Fallback Incoming Call (SIM 2)', 
