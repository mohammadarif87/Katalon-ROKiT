...
if (userName == 'Aiden') {
    ...
    Mobile.verifyElementVisible(findTestObject('Call/Rejact Call with SMS (SIM 2)/android.widget.TextView0 - Incoming call via ATT'), 
        60)

    Mobile.tap(findTestObject('Call/Rejact Call with SMS (SIM 2)/android.widget.TextView0 - Incoming call via ATT'), 0)
    ...
    Mobile.verifyElementVisible(findTestObject('Call/Rejact Call with SMS (SIM 2)/android.widget.TextView0 -   via ATT'), 
        0)
    ...
    Mobile.verifyElementVisible(findTestObject('Messages/Reject Call with SMS/android.widget.TextView1 - Ill call you later.'), 
        ...
        ) // starts almost at the bottom of the screen
    // stops scrolling almost at the top of the screen
    //Mobile.swipe(85, 2100, 0, -2100)
} else {
    Mobile.openNotifications()
    ...
    'Waiting for Answer Call button'
    Mobile.verifyElementVisible(findTestObject('Phone App/Receive a call/android.widget.Button2 - ANSWER'), 120)

    Mobile.verifyElementVisible(findTestObject('Phone App/Reject Call with SMS/android.widget.TextView5 - Incoming call via EE'), 
        60)

    Mobile.tap(findTestObject('Phone App/Reject Call with SMS/android.widget.TextView5 - Incoming call via EE'), 0)
    ...
    Mobile.verifyElementVisible(findTestObject('Phone App/Reject Call with SMS/android.widget.FrameLayout3'), 0)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Reject Call with SMS (SIM 2)', 'SIM 1 = O2-UK\nSIM 2 = EE', 
