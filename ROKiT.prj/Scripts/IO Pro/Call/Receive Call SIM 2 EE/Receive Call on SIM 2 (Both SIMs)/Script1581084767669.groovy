...
Mobile.comment('Run in parallel execution with Place Call to DUT 1 (SIM 2 EE) using IO 3D')
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Automation: Receive Call on SIM 2 (Both SIMs)', 
