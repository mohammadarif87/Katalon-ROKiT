...
Mobile.waitForElementPresent(findTestObject('Network/PLMN Search (SIM 1 - O2-UK)/android.widget.TextView0 - Network'), 180)

Mobile.verifyElementVisible(findTestObject('Network/PLMN Search (SIM 1 - O2-UK)/android.widget.TextView0 - Network'), 30)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('PLMN O2', '', TestLinkAPIResults.TEST_PASSED)
