...
Mobile.tap(findTestObject('Network/Preferred SIM for Mobile Data (SIM 1 - O2-UK)/android.view.ViewGroup5'), 3)
...
if (Mobile.verifyElementVisible(findTestObject('Apps/Extras Bookmarks/android.widget.TextView0 - Browse faster. Use less data.'), 
    ...
    Mobile.verifyElementVisible(findTestObject('Apps/Extras Bookmarks/android.widget.Button1 - Turn on Lite mode'), 3)

    Mobile.verifyElementVisible(findTestObject('Apps/Extras Bookmarks/android.widget.Button0 - No thanks'), 3)

    Mobile.tap(findTestObject('Apps/Extras Bookmarks/android.widget.Button0 - No thanks'), 3)
}
...
'Home Button'
Mobile.tap(findTestObject('Network/Preferred SIM for Mobile Data (SIM 1 - O2-UK)/android.widget.ImageButton0'), 3)

'Google Logo'
Mobile.verifyElementVisible(findTestObject('Apps/Chrome/android.widget.FrameLayout8'), 3)

Mobile.tap(findTestObject('Browser/Open Web Page/android.widget.EditText0 - Search or type web address'), 3)
...
Mobile.waitForElementPresent(findTestObject('Browser/Search/android.view.View1 - Google'), 3)
...
if (Mobile.verifyElementVisible(findTestObject('Browser/Search/android.view.View7 - Before you continue'), 0, FailureHandling.OPTIONAL)) {
    Mobile.verifyElementVisible(findTestObject('Browser/Search/android.view.View7 - Before you continue'), 3)

    Mobile.tap(findTestObject('Browser/Search/android.widget.Button1 - I agree'), 3)
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Preferred SIM for Mobile Data (SIM 1)', 
