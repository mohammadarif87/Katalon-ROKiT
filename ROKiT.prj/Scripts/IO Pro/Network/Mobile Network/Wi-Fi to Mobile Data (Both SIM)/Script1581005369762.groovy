...
Mobile.comment('This will turn off Wi-Fi')

Mobile.verifyElementVisible(findTestObject('Preconditions/Turn on Wi-Fi/android.widget.Switch0 - OFF'), 0)

Mobile.verifyElementNotVisible(findTestObject('Preconditions/Turn on Wi-Fi/android.widget.TextView3 - ROKiT Test 5G'), 0)
...
'4G Icon'
Mobile.verifyElementNotVisible(findTestObject('Network/Wi-Fi to Mobile Data (SIM 1)/android.widget.ImageView2'), 0)

'Wi-Fi Icon'
Mobile.verifyElementVisible(findTestObject('Network/Wi-Fi to Mobile Data (SIM 1)/android.widget.ImageView3'), 0)
...
not_run: Mobile.verifyElementVisible(findTestObject('Network/Wi-Fi to Mobile Data (SIM 1)/android.widget.TextView3 - ROKiT Test 5G'), 
    5)
...
Mobile.verifyElementVisible(findTestObject('Preconditions/Turn on Wi-Fi/android.widget.TextView4 - Connected'), 10)
...
Mobile.comment('Same test with SIM 2 - EE')
...
not_run: CustomKeywords.'com.kms.katalon.keyword.testlink.TestlinkKeywords.updateResults'('Wi-Fi to Mobile Data (Both SIM)', '', 
