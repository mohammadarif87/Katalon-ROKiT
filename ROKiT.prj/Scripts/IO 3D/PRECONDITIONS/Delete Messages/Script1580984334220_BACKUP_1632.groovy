...
if (Mobile.verifyElementVisible(findTestObject('Preconditions/Delete Messages/android.widget.TextView3 - New Spam protection'), 
    0, FailureHandling.OPTIONAL)) {
    Mobile.verifyElementVisible(findTestObject('Preconditions/Delete Messages/android.widget.TextView0 - Spam protection'), 
        3)

    Mobile.tap(findTestObject('Preconditions/Delete Messages/android.widget.Button0 - OK'), 0)
}
...
if (userName == 'Aiden') {
    ...
    while (Mobile.verifyElementVisible(findTestObject('Preconditions/Delete Messages/android.widget.FrameLayout3'), 0, FailureHandling.OPTIONAL)) {
        Mobile.comment('If there is a message then tap into it and delete it')
