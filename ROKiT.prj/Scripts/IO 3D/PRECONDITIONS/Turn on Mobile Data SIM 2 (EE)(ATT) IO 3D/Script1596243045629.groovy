...
WebUI.callTestCase(findTestCase('IO 3D/PRECONDITIONS/Set Mobile Data to SIM 2 (EE) IO 3D'), [('appPackage') : 'com.android.settings'
        , ('appActivity') : '.Settings', ('deviceInformation') : [('platformVersion') : '8.1.0', ('deviceName') : 'ROKiT IO 3D (Android 8.1)', ('deviceId') : '0123456789ABCDEF', ('platformName') : 'Android']], 
