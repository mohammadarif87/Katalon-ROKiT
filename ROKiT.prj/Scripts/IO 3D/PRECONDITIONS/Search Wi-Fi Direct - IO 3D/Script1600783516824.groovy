...
if (Mobile.verifyElementVisible(findTestObject('Customisation/Wi-Fi Hotspot Name/android.widget.TextView4 - IO 3D Wi-Fi Direct'), 
    0, FailureHandling.OPTIONAL)) {
    Mobile.verifyElementVisible(findTestObject('Customisation/Wi-Fi Hotspot Name/android.widget.TextView4 - IO 3D Wi-Fi Direct'), 
        0)
} else {
    'Rename Device'
    Mobile.tapAtPosition(600, 130)
    ...
    'Backscape on keyboard'
    Mobile.tapAndHoldAtPosition(700, 1210, 3)
    ...
    Mobile.setText(findTestObject('Preconditions/Rename Wi-Fi Direct/android.widget.EditText0'), 'IO 3D Wi-Fi Direct', 0)
