...
if (userName == 'Aiden') {
    ...
    'Message is present'
    Mobile.verifyElementVisible(findTestObject('Preconditions/Delete Messages/android.widget.FrameLayout3'), 0)

    'Message is present'
    Mobile.tap(findTestObject('Preconditions/Delete Messages/android.widget.FrameLayout3'), 0)
    ...
    'Play button for MMS Audio'
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Audio MMS from IO Pro/android.widget.ImageView1'), 0)

    'Audio timer states 9 seconds'
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Audio MMS from IO Pro/android.widget.Chronometer0 - 0009'), 
        0)
    ...
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Audio MMS from IO Pro/android.widget.TextView2 -   via O2 - UK'), 
        0)
}
