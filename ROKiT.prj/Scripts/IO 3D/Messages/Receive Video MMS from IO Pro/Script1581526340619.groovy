...
if (userName == 'Aiden') {
    ...
    'Video thumbnail appears as message'
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Video MMS from IO Pro/android.widget.ImageView0'), 0)

    'Play button on video'
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Video MMS from IO Pro/android.widget.ImageView0 (1)'), 
        0)

    '4 seconds on the video timer'
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Video MMS from IO Pro/android.widget.TextView0 - 004'), 
        0)

    Mobile.verifyElementVisible(findTestObject('Messages/Receive Video MMS from IO Pro/android.widget.TextView0 -   via T-Mobile'), 
        0)
} else {
    ...
    'Video thumbnail appears as message'
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Video MMS from IO Pro/android.widget.ImageView1'), 0)

    'Play button on video'
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Video MMS from IO Pro/android.widget.ImageView2'), 0)

    '4 seconds on the video timer'
    Mobile.verifyElementVisible(findTestObject('Messages/Receive Video MMS from IO Pro/android.widget.TextView1 - 004'), 
        0)
