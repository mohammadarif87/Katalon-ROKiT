...
if (userName == 'Aiden') {
    ...
    'Video saved from before'
    Mobile.verifyElementVisible(findTestObject('Messages/Send MMS Picture to IO Pro/android.widget.ImageView6'), 0)

    'Video saved from before'
    Mobile.tap(findTestObject('Messages/Send MMS Picture to IO Pro/android.widget.ImageView6'), 0)

    'Preview of video in message'
    Mobile.verifyElementVisible(findTestObject('Messages/Send MMS Picture to IO Pro/android.widget.ImageView2 (1)'), 3)
