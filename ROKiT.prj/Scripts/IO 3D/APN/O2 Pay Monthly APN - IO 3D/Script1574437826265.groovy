...
Mobile.verifyElementVisible(findTestObject('APN/IO Pro/O2-UK APN/android.widget.TextView1 - O2 - UK'), 0)
...
Mobile.verifyElementVisible(findTestObject('APN/IO 3D/O2 Pay Monthly APN - IO 3D/android.widget.TextView2 - ' + carrier_O2PayMonthly), 
    0)

Mobile.verifyElementVisible(findTestObject('APN/IO 3D/O2 Pay Monthly APN - IO 3D/android.widget.TextView3 - ' + apn_mobileo2couk), 
    0)

Mobile.tap(findTestObject('APN/IO 3D/O2 Pay Monthly APN - IO 3D/android.widget.TextView2 - ' + carrier_O2PayMonthly), 0)
